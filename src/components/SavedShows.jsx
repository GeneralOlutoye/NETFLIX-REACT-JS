                    ...
                    {movies.map((item, id) => (
                        <div key={id} className="w-[160px] sm:w-[200px] lg:w-[280px] inline-block cursor-pointer relative p-2 ">
                            <img
                                ...
                                alt={item?.title}
                            />
                            <div className="absolute top-0 left-0 w-full break-all h-full hover:bg-black/80 opacity-0 hover:opacity-100 text-white">
                                <p className="white-space-normal text-xs md:text-sm font-bold flex justify-center items-center h-full truncate text-justify">
                                    {item?.title}
                                </p>
                            </div>
                        </div>
